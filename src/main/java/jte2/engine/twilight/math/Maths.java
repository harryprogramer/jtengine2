package jte2.engine.twilight.math;
...
public class Maths {
     ...
     * @return The interpolated value between startValue and endValue.
     */
    public static jte2.engine.twilight.math.Vector3f interpolateLinear(float scale, jte2.engine.twilight.math.Vector3f startValue,
                                                                       jte2.engine.twilight.math.Vector3f endValue, jte2.engine.twilight.math.Vector3f store) {
        if (store == null) {
            store = new jte2.engine.twilight.math.Vector3f();
        }
     ...
     * @return The interpolated value between startValue and endValue.
     */
    public static jte2.engine.twilight.math.Vector3f interpolateLinear(float scale, jte2.engine.twilight.math.Vector3f startValue, jte2.engine.twilight.math.Vector3f endValue) {
...
//        }
     ...
     * @return an extrapolation for the given parameters
     */
    public static jte2.engine.twilight.math.Vector3f extrapolateLinear(float scale, jte2.engine.twilight.math.Vector3f startValue,
                                                                       jte2.engine.twilight.math.Vector3f endValue, jte2.engine.twilight.math.Vector3f store) {
        if (store == null) {
            store = new jte2.engine.twilight.math.Vector3f();
        }
...
//        }
     ...
     * @return an extrapolation for the given parameters
     */
    public static jte2.engine.twilight.math.Vector3f extrapolateLinear(float scale, jte2.engine.twilight.math.Vector3f startValue, jte2.engine.twilight.math.Vector3f endValue) {
     ...
     * @return Catmull–Rom interpolation
     */
    public static jte2.engine.twilight.math.Vector3f interpolateCatmullRom(float u, float T, jte2.engine.twilight.math.Vector3f p0,
                                                                           jte2.engine.twilight.math.Vector3f p1, jte2.engine.twilight.math.Vector3f p2, jte2.engine.twilight.math.Vector3f p3, jte2.engine.twilight.math.Vector3f store) {
        if (store == null) {
            store = new jte2.engine.twilight.math.Vector3f();
        }
     ...
     */
    public static jte2.engine.twilight.math.Vector3f interpolateCatmullRom(float u, float T, jte2.engine.twilight.math.Vector3f p0,
                                                                           jte2.engine.twilight.math.Vector3f p1, jte2.engine.twilight.math.Vector3f p2, jte2.engine.twilight.math.Vector3f p3) {
     ...
     * @return Bezier interpolation
     */
    public static jte2.engine.twilight.math.Vector3f interpolateBezier(float u, jte2.engine.twilight.math.Vector3f p0, jte2.engine.twilight.math.Vector3f p1,
                                                                       jte2.engine.twilight.math.Vector3f p2, jte2.engine.twilight.math.Vector3f p3, jte2.engine.twilight.math.Vector3f store) {
        if (store == null) {
            store = new jte2.engine.twilight.math.Vector3f();
        }
     ...
     * @return Bezier interpolation
     */
    public static jte2.engine.twilight.math.Vector3f interpolateBezier(float u, jte2.engine.twilight.math.Vector3f p0, jte2.engine.twilight.math.Vector3f p1, jte2.engine.twilight.math.Vector3f p2, jte2.engine.twilight.math.Vector3f p3) {
     ...
     */
    public static float getCatmullRomP1toP2Length(jte2.engine.twilight.math.Vector3f p0, jte2.engine.twilight.math.Vector3f p1,
                                                  jte2.engine.twilight.math.Vector3f p2, jte2.engine.twilight.math.Vector3f p3, float startRange, float endRange, float curveTension) {

        float epsilon = 0.001f;
        float middleValue = (startRange + endRange) * 0.5f;
        jte2.engine.twilight.math.Vector3f start = p1.clone();
        if (startRange != 0) {
            interpolateCatmullRom(startRange, curveTension, p0, p1, p2, p3, start);
        }
        jte2.engine.twilight.math.Vector3f end = p2.clone();
        if (endRange != 1) {
            interpolateCatmullRom(endRange, curveTension, p0, p1, p2, p3, end);
        }
        jte2.engine.twilight.math.Vector3f middle = interpolateCatmullRom(middleValue, curveTension, p0, p1, p2, p3);
     ...
     * @return the length of the segment
     */
    public static float getBezierP1toP2Length(jte2.engine.twilight.math.Vector3f p0, jte2.engine.twilight.math.Vector3f p1, jte2.engine.twilight.math.Vector3f p2, jte2.engine.twilight.math.Vector3f p3) {
        float delta = 0.02f, t = 0.0f, result = 0.0f;
        jte2.engine.twilight.math.Vector3f v1 = p0.clone(), v2 = new jte2.engine.twilight.math.Vector3f();
        while (t <= 1.0f) {
     ...
     */
    public static int counterClockwise(jte2.engine.twilight.math.Vector2f p0, jte2.engine.twilight.math.Vector2f p1, jte2.engine.twilight.math.Vector2f p2) {
     ...
     */
    public static int pointInsideTriangle(jte2.engine.twilight.math.Vector2f t0, jte2.engine.twilight.math.Vector2f t1, jte2.engine.twilight.math.Vector2f t2, jte2.engine.twilight.math.Vector2f p) {
     ...
     */
    public static jte2.engine.twilight.math.Vector3f computeNormal(jte2.engine.twilight.math.Vector3f v1, jte2.engine.twilight.math.Vector3f v2, jte2.engine.twilight.math.Vector3f v3) {
        jte2.engine.twilight.math.Vector3f a1 = v1.subtract(v2);
        jte2.engine.twilight.math.Vector3f a2 = v3.subtract(v2);
     ...
     */
    public static jte2.engine.twilight.math.Vector3f sphericalToCartesian(jte2.engine.twilight.math.Vector3f sphereCoords,
                                                                          jte2.engine.twilight.math.Vector3f store) {
        if (store == null) {
            store = new jte2.engine.twilight.math.Vector3f();
        }
     ...
     */
    public static jte2.engine.twilight.math.Vector3f cartesianToSpherical(jte2.engine.twilight.math.Vector3f cartCoords,
                                                                          jte2.engine.twilight.math.Vector3f store) {
        if (store == null) {
            store = new jte2.engine.twilight.math.Vector3f();
        }
     ...
     * @return the Cartesian coordinates (either store or a new vector)
     */
    public static jte2.engine.twilight.math.Vector3f sphericalToCartesianZ(jte2.engine.twilight.math.Vector3f sphereCoords,
                                                                           jte2.engine.twilight.math.Vector3f store) {
        if (store == null) {
            store = new jte2.engine.twilight.math.Vector3f();
        }
        store.y = sphereCoords.x * sin(sphereCoords.y);
        float a = sphereCoords.x * cos(sphereCoords.y);
        store.x = a * cos(sphereCoords.z);
        store.z = a * sin(sphereCoords.z);
     ...
     */
    public static jte2.engine.twilight.math.Vector3f cartesianZToSpherical(jte2.engine.twilight.math.Vector3f cartCoords,
                                                                           jte2.engine.twilight.math.Vector3f store) {
        if (store == null) {
            store = new jte2.engine.twilight.math.Vector3f();
        }
    ...
    public static @NotNull Vector2f vector3Dto2D(@NotNull Vector3f vector3f){
        return new Vector2f(vector3f.x, vector3f.y);
    }

    @Contract(value = "_ -> new", pure = true)
    public static @NotNull Vector3f vector2Dto3D(jte2.engine.twilight.math.@NotNull Vector2f vector2f){
    ...
    public static int getAbsoluteAngle(int angle, int absoluteAngle){
        int a = angle / absoluteAngle;
        return a - (a * absoluteAngle);
    }
    ...
    public static float getAbsoluteAngle(float angle, int absoluteAngle){
        int a = (int) (angle / absoluteAngle);
        return a - (a * absoluteAngle);
    }
    ...
    public static double getAbsoluteAngle(double angle, int absoluteAngle){
        int a = (int) (angle / absoluteAngle);
        return a - (a * (double) absoluteAngle);
    }
}
