...
public class DecodeAndPlayVideo {
    ...
    private static void playVideo(String filename) throws InterruptedException, IOException {
        ...
        System.out.println("video timebase: " + streamTimebase.toString());
        ...
        while(demuxer.read(packet) >= 0) {
            ...
            if (packet.getStreamIndex() == videoStreamId)
            {
                ...
                do {
                    ...
                    System.out.println("frame: " + frame + " of " + videoDecoder.getFrameCount() + ", time: " + (endTime - startTime) / 1000.0);
                    if (picture.isComplete()) {
                        System.out.println(streamStartTime + " " + systemTimeBase.toString() + " " + streamTimebase);
    ...
    private static BufferedImage displayVideoAtCorrectTime(long streamStartTime,
                                                           final @NotNull MediaPicture picture, final MediaPictureConverter converter,
                                                           BufferedImage image, final ImageFrame window, long systemStartTime,
                                                           final @NotNull Rational systemTimeBase, final Rational streamTimebase)
        ...
        try {
            ...
            if (cmd.hasOption("version")) {
                ...
                for(String arg: parsedArgs)
                    playVideo("C:\\Users\\szymo\\IdeaProjects\\jtengine2\\res\\video\\video2.mp4");
            }
