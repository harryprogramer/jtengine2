    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        try {
            ...
            if (cmd.hasOption("version")) {
                ...
                formatter.printHelp(ContainerInfoTest.class.getCanonicalName() + " [<filename> ...]", options);
            } else {
                final String[] parsedArgs = cmd.getArgs();
                for(String arg: parsedArgs)
                    getInfo("C:\\Users\\szymo\\IdeaProjects\\jtengine2\\res\\video\\video1.mp4");
                    getInfo("C:\\Users\\szymo\\IdeaProjects\\jtengine2\\res\\video\\video2.mp4");
            }
